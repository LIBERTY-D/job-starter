...
export default function SignUp() {
    const [userData, setUserData] = useState<{ email: string; password: "","first-name":string,"last-name":string }>({
        email: "",
        password: "",
        'first-name':"",
        "last-name":""
      ...
      const handleSubmit = async (e: React.MouseEvent<HTMLButtonElement>) => {
        ...
        if(userData.email==""|| userData["first-name"]=="" ||userData["last-name"]=="" || userData.password==""){
  ...
  return (
    <main className="mt-40">
      ...
      <Form  type="SIGNUP" handleSubmit={handleSubmit} handleChange={handleChange} />
    </main>
  );
  }
